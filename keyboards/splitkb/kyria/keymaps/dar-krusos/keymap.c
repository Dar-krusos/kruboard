...
*/
    [_LOWER] = LAYOUT(
     ...
     KC_DEL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                           KC_CIRC, KC_KP_4, KC_KP_5, KC_KP_6, KC_PPLS, KC_PENT,
     _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_NO,   KC_NO,      KC_LPRN, KC_RPRN, KC_UNDS, KC_KP_1, KC_KP_2, KC_KP_3, KC_PAST, KC_PSLS,
